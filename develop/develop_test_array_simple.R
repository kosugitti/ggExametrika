...
# Test with white boundary lines
cat("=== Test 6: White boundary line color ===\n")
plot_white_lines <- plotArray_gg(result_multi, Clusterd_lines_color = "white", show_legend = TRUE)
cat("✓ Array plot with white boundary lines created\n\n")

cat("=== All tests completed successfully ===\n")
cat("\nTo view plots, run:\n")
cat("  plot_binary        # Binary data (white/black)\n")
cat("  plot_multi         # Multi-valued (colored, no legend)\n")
cat("  plot_multi_legend  # Multi-valued (colored, with legend)\n")
cat("  plot_custom        # Custom title version\n")
cat("  plot_blue_lines    # Custom blue boundary lines\n")
cat("  plot_white_lines   # White boundary lines\n")
